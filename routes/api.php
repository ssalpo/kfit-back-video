...
Route::middleware('check.token')->group(function () {
    ...
    Route::post('/courses/{course}/change-activity', [\App\Http\Controllers\ApiV1\CourseController::class, 'changeActivity']);
    ...
    Route::post('/workouts/{workout}/change-activity', [\App\Http\Controllers\ApiV1\WorkoutController::class, 'changeActivity']);
