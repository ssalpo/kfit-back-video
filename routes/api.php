...
Route::middleware('check.token')->group(function () {
    ...
    Route::get('/courses/all', [\App\Http\Controllers\ApiV1\CourseController::class, 'all']);
    ...
    Route::get('/workouts/all', [\App\Http\Controllers\ApiV1\WorkoutController::class, 'all']);
